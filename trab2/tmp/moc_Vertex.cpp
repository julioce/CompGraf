...
**
** Created: Sat Oct 15 14:09:49 2011
...
static const char qt_meta_stringdata_Vertex[] = {
    "Vertex\0"
};

const QMetaObject Vertex::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Vertex,
      qt_meta_data_Vertex, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Vertex::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Vertex))
